...
import com.nrp.controller.mapper.DriverMapper;
import com.nrp.datatransferobject.DriverDTO;
...
public class DriverController {
    ...
    @GetMapping("/{driverId}")
    public DriverDTO getDriver(@jakarta.validation.Valid @PathVariable long driverId) throws EntityNotFoundException {
